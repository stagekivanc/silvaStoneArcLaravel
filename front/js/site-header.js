(function renderSiteHeader() {
  ...
  xhr.open('GET', 'header.html?v=8', false);
  try {
    xhr.send();
...
<header id="site-header" class="fixed inset-x-0 top-0 z-[60] transition-all duration-500">
  <div class="header-bar relative mx-auto grid max-w-[1440px] grid-cols-3 items-center px-4 py-4 md:px-8 md:py-5">
    <div class="menu-wrap relative justify-self-start">
      ...
      <div id="nav-dropdown" class="nav-dropdown" aria-hidden="true">
        ...
        <nav class="nav-dropdown-inner">
          ...
          <a href="urunler.html" class="nav-drop-link">Panel Koleksiyonu</a>
          <a href="magazalar.html" class="nav-drop-link">Showroom</a>
          <a href="bayi-basvuru.html" class="nav-drop-link">Bayi Ol</a>
          ...
          <div class="nav-drop-mobile">
            ...
            <a href="bayi-basvuru.html" class="nav-drop-cta">Bayi Ol</a>
    ...
    <a href="index.html" class="header-brand justify-self-center flex flex-col items-center leading-none">
      <img src="assets/silvalogo-white.svg" alt="Silva Arc Panel" class="logo-header-light h-14 w-auto md:h-14" />
      <img src="assets/silvalogo.svg" alt="Silva Arc Panel" class="logo-header-dark hidden h-14 w-auto md:h-14" />
    </a>
    <div class="header-actions flex items-center justify-self-end gap-2 md:gap-2.5">
      ...
      <a href="bayi-basvuru.html" class="pill-btn header-cta inline-flex items-center gap-1.5 rounded-full px-4 py-3 text-[13px] font-medium md:gap-2 md:px-6 md:text-[15px]">
        <span class="header-cta-text">Bayi Ol</span>
