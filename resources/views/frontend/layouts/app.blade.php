...
<head>
  ...
  <title>@hasSection('title')@yield('title')@else{{ data_get($layoutPage, 'seo_title') ?: data_get($layoutPage, 'title') ?: \App\Models\Setting::get('site_name', 'Silva Arc Panel') }}@endif</title>
  ...
  <meta property="og:site_name" content="{{ \App\Models\Setting::get('site_name', 'Silva Arc Panel') }}" />
  ...
  @php($silvaRoutes = ['home' => route('home', ['lang' => app()->getLocale()]), 'products' => m_url('products'), 'stores' => m_url('stores'), 'contact' => m_url('contact'), 'dealer' => m_url('dealer'), 'privacy' => m_url('privacy-policy'), 'cookies' => m_url('cookie-policy'), 'kvkk' => m_url('kvkk'), 'contracts' => m_url('contracts')])
  <script>
