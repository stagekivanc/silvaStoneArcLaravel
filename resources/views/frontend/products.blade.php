...
@section('title', data_get($page, 'seo_title') ?: 'Ürünler | Silva Arc Panel')
@section('meta_description', data_get($page, 'seo_description') ?: 'Silva Arc Panel Wood, Metal, Kök ve Traverten dekoratif duvar panelleri.')
