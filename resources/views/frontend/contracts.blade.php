...
@section('title', data_get($page, 'seo_title') ?: 'Sözleşmeler | Silva Arc Panel')
@section('meta_description', data_get($page, 'seo_description') ?: 'Silva Arc Panel gizlilik, aydınlatma, çerez, güvenlik ve KVKK metinleri.')
