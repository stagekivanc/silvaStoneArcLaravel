...
@section('title', data_get($page, 'seo_title') ?: 'Projeler | Silva Arc Panel Uygulamaları')
@section('meta_description', data_get($page, 'seo_description') ?: 'Silva Arc Panel dekoratif taş panellerinin otel, konut, restoran ve cephe uygulamaları.')
