...
@section('title', data_get($page, 'seo_title') ?: 'İletişim | Silva Arc Panel')
@section('meta_description', data_get($page, 'seo_description') ?: 'Silva Arc Panel proje, numune ve showroom talepleri için Acarkon ekibiyle iletişime geçin.')
