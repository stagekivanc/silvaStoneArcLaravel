...
@section('title', data_get($page, 'seo_title') ?: 'Showroom | Silva Arc Panel')
@section('meta_description', data_get($page, 'seo_description') ?: 'Türkiye genelindeki Acarkon Store’larda Silva Arc Panel panelleri görün, dokunun ve sipariş edin.')
