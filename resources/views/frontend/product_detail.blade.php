...
@section('title', ($product->seo_title ?: $product->name) . ' | Silva Arc Panel')
            ...
            <div id="panel-aciklama" role="tabpanel" aria-labelledby="tab-aciklama" class="detail-panel active">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
                    <div class="space-y-5">
                        ...
                        <p class="text-sm text-gray-500 font-light leading-relaxed">Silva Arc Panel kalitesiyle üretilen bu ürün, kurumsal logo baskı ve nakış uygulamaları ile kişiselleştirilebilir. Toptan siparişlerde özel fiyatlandırma sunulmaktadır.</p>
                    </div>
