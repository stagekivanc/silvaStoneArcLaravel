                    ...
                    <div class="space-y-6">
                        <div class="bg-blue-50 p-6 rounded-2xl border border-blue-100 flex items-start gap-4 mb-6">
                            ...
                            <div class="text-sm text-blue-800 leading-relaxed">
                                ...
                                <p class="mt-2"><strong>Site Key</strong> ve <strong>Secret Key</strong> kaydedildiğinde iletişim, bayilik ve teklif formlarında otomatik aktif olur. Anahtarlardan biri boşsa kapalıdır.</p>
                                <p class="mt-2">`.env` içinde <code class="font-mono text-xs bg-white/70 px-1.5 py-0.5 rounded">RECAPTCHA_SITE_KEY</code> / <code class="font-mono text-xs bg-white/70 px-1.5 py-0.5 rounded">RECAPTCHA_SECRET_KEY</code> tanımlıysa bunlar panel anahtarlarının önüne geçer. Zorla kapatmak için <code class="font-mono text-xs bg-white/70 px-1.5 py-0.5 rounded">RECAPTCHA_ENABLED=false</code> kullanın.</p>
                                @if(recaptcha_enabled())
                                    <p class="mt-2 font-bold text-emerald-700">reCAPTCHA şu an aktif.</p>
                                @else
                                    <p class="mt-2 font-bold text-amber-700">reCAPTCHA şu an pasif (her iki anahtar da gerekli).</p>
                                @endif
                            </div>
                        </div>
