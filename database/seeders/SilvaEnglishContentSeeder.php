...
class SilvaEnglishContentSeeder extends Seeder
{
    ...
    private function seedUiStrings(): void
    {
        $rows = [
            ...
            'footer_brand_text' => ['tr' => 'Silva Arc Panel, Acarkon Orman Ürünleri ürün ailesinin dekoratif duvar paneli markasıdır.', 'en' => 'Silva Arc Panel is the decorative wall panel brand of the Acarkon Forest Products family.'],
