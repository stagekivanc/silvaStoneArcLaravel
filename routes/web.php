...
Route::group(['prefix' => '{lang}', 'where' => ['lang' => '[a-z]{2}']], function () {
    ...
    Route::post('/bayilik-basvuru', [HomeController::class, 'storeDealer'])->name('dealer.store');
    Route::post('/dealer-application', [HomeController::class, 'storeDealer']);
...
Route::prefix('yonetim')->name('yonetim.')->group(function () {
    ...
    Route::middleware(['auth:admin'])->group(function () {
        ...
        Route::get('/bayilik-basvurulari', [\App\Http\Controllers\Admin\DealerApplicationController::class, 'index'])->name('bayilik.index');
        Route::get('/bayilik-basvurulari/{id}', [\App\Http\Controllers\Admin\DealerApplicationController::class, 'show'])->name('bayilik.show');
        Route::patch('/bayilik-basvurulari/{id}/toggle-read', [\App\Http\Controllers\Admin\DealerApplicationController::class, 'toggleRead'])->name('bayilik.toggle-read');
        Route::delete('/bayilik-basvurulari/{id}', [\App\Http\Controllers\Admin\DealerApplicationController::class, 'destroy'])->name('bayilik.destroy');
        ...
        // Proje Yönetimi kaldırıldı (Silva Arc Panel)
