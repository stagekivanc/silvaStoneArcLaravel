(function SilvaCart() {
  ...
  const mount = () => {
      ...
      <aside class="cart-drawer" id="cart-drawer" aria-hidden="true" aria-labelledby="cart-title">
        ...
        <div class="cart-body">
          <div class="cart-empty" id="cart-empty">
            ...
            <p>Sepetiniz boş.</p>
            <a href="${(window.SILVA_ROUTES && window.SILVA_ROUTES.products) || 'urunler.html'}" class="cart-empty-btn">Ürünlere git</a>
          </div>
    ...
    document.getElementById('quote-form')?.addEventListener('submit', (e) => {
      ...
      const mailto = `mailto:bilgi@acarkon.com?subject=${encodeURIComponent('Silva Arc Panel teklif talebi')}&body=${encodeURIComponent(lines.join('\n'))}`;
